...
// bg-black/40 backdrop-blur-sm px-4
  return (
   ...
   {/* <div className="relative flex w-2/3">
      <textarea
        ...
        className="h-16  p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none text-white font-semibold"
      />

      {/* <button className="w-1/6"><EmojiEmotionsIcon/></button> */}
       {/* <EmojiEmotionsIcon */}
    {/* onClick={() => console.log("Open emoji picker")} */}
    {/* className="absolute right-2 top-2 cursor-pointer text-yellow-400 hover:text-yellow-500" */}
  {/* /> */}
  ...
  <textarea
    ...
    value={scheduletext}
    onChange={(e) => setScheduletext(e.target.value)}
    className="h-16 w-full p-3 pr-10 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none text-white font-semibold"
  />
  <EmojiEmotionsIcon
  ...
  {showEmojiPicker && (
    <div className="absolute top-15 w-full right-0 z-50">
      ...
      <div className="w-1/3 flex items-center justify-center bg-[pink] font-semibold border border-dashed border-gray-300 rounded-md text-gray-600 text-sm p-4 cursor-pointer" onClick={showtime}>
